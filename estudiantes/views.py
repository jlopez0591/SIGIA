...
from estudiantes.forms import StudentUpdateForm
...
class TrabajoGraduactionCreateView(PermissionRequiredMixin, CreateView):
    model = TrabajoGraduacion
    permission_required = 'estudiante.add_trabajo'
...
class TrabajoGraduacionFacultadListView(PermissionRequiredMixin, ListView):
    ...
    def get_queryset(self):
        qs = TrabajoGraduacion.objects.all()
        return qs
