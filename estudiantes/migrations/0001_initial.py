    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, upload_to='')),
                ('anteproyecto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='estudiantes.Anteproyecto')),
            ...
            options={
                'permissions': (('ver_proyecto_facultad', 'Ver proyectos en facultad'), ('ver_proyecto_escuela', 'Ver proyectos en escuela')),
            },
        ),
        migrations.AddField(
